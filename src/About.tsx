  ...
  return (
    <div className="min-h-screen px-6 py-20 text-center text-zinc-900 dark:text-zinc-100">
      ...
      <section className="mt-16 grid md:grid-cols-3 gap-10 max-w-6xl mx-auto text-left">
        <div>
          ...
          <p className="text-zinc-600 dark:text-zinc-400">
            ...
            without writing code, while still offering power and precision when
            needed.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-zinc-600 dark:text-zinc-400">
            We imagine a future where software is built from blocks — reusable,
            remixable, and transparent. Dsentr is our step toward that future: a
            tool that balances simplicity with depth.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-zinc-600 dark:text-zinc-400">
            Dsentr is built around clarity, composability, and trust. We believe
            great tools should be invisible when you're in flow — reliable,
            fast, and tailored to the way you think. Every design decision
            reflects our focus on user empowerment and long-term
            maintainability.
          </p>
        </div>
      </section>
      ...
      <section className="mt-20 max-w-4xl mx-auto">
        <h2 className="text-2xl font-semibold mb-4">The Story Behind Dsentr</h2>
        <p className="text-zinc-600 dark:text-zinc-400">
        ...
        <p className="mt-4 text-zinc-600 dark:text-zinc-400">
          Whether you're a solo maker or an engineering team, Dsentr is designed
          to give you the building blocks to move fast and automate confidently.
        </p>
      </section>
    </div>
  )
